...
4: There are about 250respondents with High school graduate or Some high school or Elementary/grade school.
...
```{r}
##Top 10 genres (command it out due to an issue for knit to PDF file)
#genres_last_month %>% 
